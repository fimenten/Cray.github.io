var _a;
export const graph = {}; // ← 既存のデシリアライズ結果をここに
export const rootEl = document.getElementById("root"); // ← ルート要素
// Safari 対策: requestIdleCallback ポリフィル
const ric = (_a = window.requestIdleCallback) !== null && _a !== void 0 ? _a : ((cb) => setTimeout(() => cb({
    didTimeout: false,
    timeRemaining: () => 0
}), 1));
export function hydrateGraph(rootId) {
